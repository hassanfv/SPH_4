 ...
 * Copyright (c) 2020 Alexander Richings (a.j.richings@hull.ac.uk)
 *
...
#ifndef CHIMES_PROTO_H
#define CHIMES_PROTO_H 
...
struct gasVariables
{
  ...
  ChimesFloat *flux_reduction_factor;    /*!< Relative change in photon fluxes (dimensionless). Only used when coupling to RT. */ 
  ...
  ChimesFloat *rt_source_term;           /*!< Photon source term from the radiative transfer equations, in photons cm^-3 s^-1. */ 
  ...
  ChimesFloat dust_boost_factor;         /*!< Multiplicative factor to boost reactions on dust grain surfaces. */ 
...
struct globalVariables
{
  ...
  int rt_update_flux;                          /*!< 0 - photon density is constant; 1 - updates fluxes as photons are used up in ionisations. */ 
  int rt_use_on_the_spot_approx;               /*!< 0 - Recombinations of HII and HeII contribute to the photon density; 1 - use on the spot approximation. */ 
  ...
  ChimesFloat Tmol_K;                          /*!< Disable molecules above this temperature. */ 
  ...
  ChimesFloat rt_density_absoluteTolerance;    /*!< Absolute tolerance for integrating the photon density. */ 
  ChimesFloat rt_flux_absoluteTolerance;       /*!< Absolute tolerance for integrating the photon flux reduction factor. */ 
  ...
  void *hybrid_data;                           /*!< Structure containing extra data for the hybrid cooling function. */
  ChimesFloat (*hybrid_cooling_fn)(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars); /*!< Hybrid cooling function. */
...
{ 
  ...
  ChimesFloat *G0_parameter;             /*!< Strength of the 6-13.6 eV FUV band for each spectrum. Units: Habing. */ 
  ChimesFloat *H2_dissocJ;               /*!< n / (isotropic_photon_density * c) for each spectrum, where n is photon number density in the 12.24-13.51 eV band. */
  int *HII_recombination_flag;           /*!< Integer flag to indicate which spectrum includes HII recombination. Only used with RT coupling. */ 
  int *HeII_recombination_flag;          /*!< Integer flag to indicate which spectrum includes HeII recombination. Only used with RT coupling. */ 
...
struct UserData
{
  ...
  const struct globalVariables *myGlobalVars;               /*!< The #globalVariables struct. */ 
...
struct chimes_current_rates_struct
{
  ...
  ChimesFloat *recombination_AB_rate_coefficient_diff;  /*!< Difference in case A and B rate coefficients. */ 
  ChimesFloat *recombination_AB_rate_diff;           /*!< Difference in case A and B rates. */ 
  ...
  ChimesFloat *photon_density_rate;                  /*!< Current rates for photon density. Only used with RT coupling. */ 
  ChimesFloat *photon_flux_rate;                     /*!< Current rates for photon flux. Only used with RT coupling. */ 
...
// chimes_cooling.c 
ChimesFloat calculate_mean_molecular_weight(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars); 
ChimesFloat calculate_total_cooling_rate(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data, int mode); 
ChimesFloat chimes_cooling_rate_external(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, int mode); 
ChimesFloat calculate_total_number_density(ChimesFloat *my_abundances, ChimesFloat nH, const struct globalVariables *myGlobalVars); 
...
ChimesFloat OH_rotational_cooling(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data); 
void update_cooling_rates(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data); 

// chimes.c 
int chimes_network(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars);
...
void chimes_print_gas_vars(FILE *log_file, struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars); 

// init_chimes.c
void chimes_exit_default(void); 
void allocate_gas_abundances_memory(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars);
void free_gas_abundances_memory(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars); 
...
void initialise_gas_abundances(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars);
...
void determine_current_rates_buffer_size(int *buffer_size, const struct globalVariables *myGlobalVars); 
void allocate_current_rates_memory(struct chimes_current_rates_struct *chimes_current_rates, const struct globalVariables *myGlobalVars); 
void free_current_rates_memory(struct chimes_current_rates_struct *chimes_current_rates, const struct globalVariables *myGlobalVars); 
...
// rate_equations.c 
void check_constraint_equations(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars);
int f(realtype t, N_Vector y, N_Vector ydot, void *user_data);

// update_rates.c 
void set_initial_rate_coefficients(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data); 
void set_species_structures(struct Species_Structure *mySpecies, struct gasVariables *myGasVars, int *total_network, int *nonmolecular_network, const struct globalVariables *myGlobalVars);
void zero_molecular_abundances(struct Species_Structure *mySpecies, struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars); 
void update_rt_photochemistry_coefficients(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data); 
void update_rate_coefficients(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data, int mode); 
void update_rate_vector(struct Species_Structure *mySpecies, struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data); 
void update_rates(struct gasVariables *myGasVars, const struct globalVariables *myGlobalVars, struct UserData data); 
