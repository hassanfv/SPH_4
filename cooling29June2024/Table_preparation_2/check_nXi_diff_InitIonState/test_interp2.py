...
# Here I also plot the nH0/nH ratio as an indicator of ionization level to check how it is different for those degenarate points!
...
plt.savefig('figX2.png', dpi = 300, bbox_inches = 'tight') # Great! This confirms the idea !!!
