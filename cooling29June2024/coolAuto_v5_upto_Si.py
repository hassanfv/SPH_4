...
def func(t, y):
  ...
  ntot = (
         ...
         + nSiXI + nSiXII + nSiXIII + nSiXIV + nSiXV
         )
  ...
  dne_dt = (
           ...
           + 12 * dnSiXIII_dt + 13 * dnSiXIV_dt + 14 * dnSiXV_dt
           )
  ...
  dntot_dt = (
              ...
              + dnSiXI_dt + dnSiXII_dt + dnSiXIII_dt + dnSiXIV_dt + dnSiXV_dt
             )
  ...
  return [
          ...
          dnMgXII_dt, dnMgXIII_dt, dnSiI_dt, dnSiII_dt, dnSiIII_dt, dnSiIV_dt,
          dnSiV_dt, dnSiVI_dt, dnSiVII_dt, dnSiVIII_dt, dnSiIX_dt, dnSiX_dt,
          dnSiXI_dt, dnSiXII_dt, dnSiXIII_dt, dnSiXIV_dt, dnSiXV_dt, dT_dt
         ]
...
y0 = [
      ...
      nSi10_i, nSi11_i, nSi12_i, nSi13_i, nSi14_i, 
      T_i
      ]
