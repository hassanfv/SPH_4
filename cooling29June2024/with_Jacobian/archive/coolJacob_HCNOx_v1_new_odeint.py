...
t = np.arange(1., 100, 10)*3.16e7  # This 50000 is the number of points in linspace

TT = time.time()
solution = odeint(func, y0, t, tfirst=True, atol=atol, rtol=rtol)
...
nH0, nHp, nHm, nHe0, nHep, nHepp = y[0], y[1], y[2], y[3], y[4], y[5]
nC0, nC1, nC2, nC3, nC4, nC5, nC6, nCm = y[6], y[7], y[8], y[9], y[10], y[11], y[12], y[13]
nN0, nN1, nN2, nN3, nN4, nN5, nN6, nN7 = y[14], y[15], y[16], y[17], y[18], y[19], y[20], y[21]
nO0, nO1, nO2, nO3, nO4, nO5, nO6, nO7, nO8, nOm = y[22], y[23], y[24], y[25], y[26], y[27], y[28], y[29], y[30], y[31]
T = y[32]
